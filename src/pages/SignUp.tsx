...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await signup(fullName, formData.email, formData.password, formData.isSkiller);
      navigate('/dashboard');
    } catch (err) {
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="isSkiller" className="text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="agreeToTerms" className="text-sm">
                      I agree to the <Link to="/terms-of-service" className="text-blue-600">Terms of Service</Link> and <Link to="/privacy-policy" className="text-blue-600">Privacy Policy</Link>
                    </Label>
                  </div>
                </div>

                <Button type="submit" disabled={isLoading} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
              ...
              <div className="grid grid-cols-3 gap-3">
                {socialLogins.map((social) => (
                  <Button key={social.name} variant="outline">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {benefits.map((benefit, index) => (
                <motion.div key={benefit.title} initial={{ opacity: 0, y: 20 }} animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }} transition={{ duration: 0.6, delay: 0.4 + index * 0.1 }} className="flex items-start space-x-4">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }} transition={{ duration: 0.6, delay: 0.8 }} className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-6 text-white">
